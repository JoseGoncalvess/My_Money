...
import '../eventopage/widgets/form_event_widget.dart';
import '../home_page/home_controller.dart';

class EditingPage extends StatefulWidget {
  final String nameEvent;
  final String valorEvent;
...
class _EditingPageState extends State<EditingPage>
  ...
  void initState() {
    ...
    parcelcontroller
        .initvalue(payment: widget.paymentEvent, numParcel: widget.parcelEvent)
        .then((value) => setState(
              () => payment = value,
            ));
    _eventotexteditController.text = widget.nameEvent;
    _valorController.text = widget.valorEvent;
    _eventocontroller.value = widget.dataEvent;
  }
